...
import { fetchBlogCategories, fetchBlogPosts, fetchBlogTags } from '../api/blogs'
import './blog.scss'
                                    ...
                                    <div className="d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div className="b-overlay-container">
                                            <div className="featured-image-container">
                                                <LazyImage type={featured.image.type} value={featured.image.value} containerClass="featured-image-container" imgClass="feat-image" />
                                            </div>
