...
const ReachNepal = () => (
  <Layout>
    <SEO
      title="Reach Nepal"
      description="Update the website to give it a modern look, add functionality and update user flow. "
    />
    <Portfolio
      projectName="Reach Nepal"
      projectCategory="UI/UX, Front-end, Custom API"
      projectLink="https://reachnepal.org"
      ...
      techUsed={["Figma", "React", "SCSS", "OAuth"]}
      nextPage="/work/cryptox"
    ></Portfolio>
  </Layout>
)
