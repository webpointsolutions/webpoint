          ...
          <div className="row justify-content-center">
            <div className="col-lg-4">
              ...
              <div className="services-info-text">
                <p>
                  We provide a wide range of services for your website needs, to
                ...
                <div className="col-md-4">
                  <div className="wp-services-container">
                    <div className="wp-services-bg">
                      ...
                      <h2>WooCommerce</h2>
                      <p className="wp-service-description">
                        We integrate WooCommerce and customize according to your
                        entire ecommerce business solutions needs.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="wp-services-bg">
                    ...
                    <p className="wp-service-description">
                      We will provide hosting services and range of maintenance
                      -from 24/7 support, periodical theme & plugin updates,
                      routine backups to premiumsecurity updates.
                    </p>
                  </div>
                </div>
              </div>
